...
// SetInterval me permite ejecutar una función cada n cantidad de tiempo, por lo que quiere que recibe como argumentos: Función a ejecutarse, intervalo de tiempo.
//A tener  en cuenta esta función no se detiene y continúa su ejecución ad infinitum.
setInterval(function () {
  console.log(
    "Voy a contar hasta infinito, detén mi ejecución o consumo tu memoria"
  ),
    1000;
...
setInterval(function () {
  ...
  //Hay que escuchar los errores, es muy imporante de todo lo que pase en el código. Comprobar funciones y revisar lo que posiblemente puede fallar.
